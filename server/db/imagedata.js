...
let images = [
  [
    ...
    {
      _id: 6,
      url: 'https://propertygallery.s3-us-west-1.amazonaws.com/Hawaii+Set+1/Outside1.jpg',
  ...
  [
    ...
    {
      _id: 19,
      url: 'https://propertygallery.s3-us-west-1.amazonaws.com/Jamaica/diningarea.jpg',
      caption: 'View to dining area',
      verified: faker.random.boolean(),
    },
  ],
